...
const Dashboard: React.FC = () => {
  ...
  const [monthAvilability, setMnthAvilability] = useState<
  ...
  useEffect(() => {
    api.get(`/providers/${user.id}/month-availability`, {
      ...
      setMnthAvilability(response.data);
    })
  ...
  useEffect(() => {
    ...
    .then(response => {
      const appointmentsFormetted = response.data.map(appointment => {
        return {
          ...appointment,
      ...
      setAppointments(appointmentsFormetted);
    });
  }, [selectedDate])

  const disabledDays = useMemo(() => {
    const dates = monthAvilability
